...
def main():
    ...
    f3 = open(readfile()[2], "a")                                           # apro outfile per scrittura
    
    for y in readfile()[1]:                                                 # leggo le righe di file_hash
        for i in readfile()[0]:                                             # leggo le righe di file_clear    
            if y.split(":")[0].lower() == i.split(":")[3].lower():                          # if hash = hash allora sostituisco con cleartext
                #print (i.split(":")[0] + ":" + y.split(":")[1], end ="")
                f3.write(i.split(":")[0] + ":" + y.split(":")[1])           # scrivo su file l'output
